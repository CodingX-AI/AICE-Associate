...
## 🚨 [다운로드 전 필독] 실습 파일 다운로드 및 압축 파일 암호 안내

> 코딩엑스(CodingX) **「AICE ASSOCIATE 실전대비서」** 교재의 실습 코드 및 데이터 저장소입니다.\
> 교재에서 제공되는 **모의고사 4회(해설 포함)** 및 **실전 모의고사 2회(문제, 정답 파일 제공)** 의 실습 파일을 제공하며,\
